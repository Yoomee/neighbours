class HomeController < ApplicationController
  ...
  def index
    ...
    @helped = Need.resolved.order(:created_at).reverse_order.at_least(20) if @general_offers.empty?
    @needs = Need.unresolved.deadline_in_future.order(:created_at).reverse_order.at_least(20)
